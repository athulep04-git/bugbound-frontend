...
function LandingPage() {
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen scroll-smooth">
      ...
      >
        ...
        <div className="relative max-w-5xl bg-white/90 border border-gray-200
                        shadow-2xl rounded-3xl p-14">
          ...
          <div className="flex justify-center gap-5">
            <Link to={'/register'}>
<button className="px-12 py-4 rounded-xl text-lg text-white
                               bg-gradient-to-r from-blue-600 to-purple-600
            ...
            <button className="px-12 py-4 rounded-xl text-lg border
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
            ...
            <div className="p-8 bg-white/90 backdrop-blur rounded-3xl border shadow
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
            ...
            <div className="p-10 bg-white/90 rounded-3xl border shadow
                            hover:scale-105 hover:bg-blue-600 hover:text-white transition">
              <div className="text-5xl mb-4"></div>
              <h3 className="text-2xl font-semibold mb-3">Structured Bug Posting</h3>
            ...
            <div className="p-10 bg-white/90 rounded-3xl border shadow
              ...
              <div className="text-5xl mb-4"></div>
              <h3 className="text-2xl font-semibold mb-3">Merit-Based Rewards</h3>
